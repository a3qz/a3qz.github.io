        ...
        try {
            DeviceMotionEvent.requestPermission().then(function (response) {
                ...
                window.addEventListener('deviceorientation', function (event) {
                    ...
                    _this.bottle.angle = 180 - rotation_degrees;
                });
            });
        }
        catch (ex) {
